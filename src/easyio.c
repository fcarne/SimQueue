...
//	max   : superior limit
//
long read_long(const char *prompt, const char *unit, long def, long min,
		long max) {
...
//	max   : superior limit
//
double read_double(const char *prompt, const char *unit, double def, double min,
		double max) {
...
//	def   : proposed default
//
char* read_string(const char *prompt, const char *def) {
